...
public:
    ...
    QPushButton *EyeRecruiter1;
    QPushButton *EyeRecruiter_2;
    QPushButton *EyeRecruiter_3;
    QPushButton *EyeRecruiter_4;
    QPushButton *EyeRecruiter_5;
    QPushButton *EyeRecruiter_6;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ButtonRecruiter->setGeometry(QRect(1300, 420, 61, 41));
        ...
        widget->setGeometry(QRect(1260, 520, 111, 381));
        verticalLayout_2 = new QVBoxLayout(widget);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        EyeRecruiter1 = new QPushButton(widget);
        EyeRecruiter1->setObjectName(QString::fromUtf8("EyeRecruiter1"));
        EyeRecruiter1->setFlat(true);

        verticalLayout_2->addWidget(EyeRecruiter1);

        EyeRecruiter_2 = new QPushButton(widget);
        EyeRecruiter_2->setObjectName(QString::fromUtf8("EyeRecruiter_2"));
        EyeRecruiter_2->setFlat(true);

        verticalLayout_2->addWidget(EyeRecruiter_2);

        EyeRecruiter_3 = new QPushButton(widget);
        EyeRecruiter_3->setObjectName(QString::fromUtf8("EyeRecruiter_3"));
        EyeRecruiter_3->setFlat(true);

        verticalLayout_2->addWidget(EyeRecruiter_3);

        EyeRecruiter_4 = new QPushButton(widget);
        EyeRecruiter_4->setObjectName(QString::fromUtf8("EyeRecruiter_4"));
        EyeRecruiter_4->setFlat(true);

        verticalLayout_2->addWidget(EyeRecruiter_4);

        EyeRecruiter_5 = new QPushButton(widget);
        EyeRecruiter_5->setObjectName(QString::fromUtf8("EyeRecruiter_5"));
        EyeRecruiter_5->setFlat(true);

        verticalLayout_2->addWidget(EyeRecruiter_5);

        EyeRecruiter_6 = new QPushButton(widget);
        EyeRecruiter_6->setObjectName(QString::fromUtf8("EyeRecruiter_6"));
        EyeRecruiter_6->setFlat(true);

        verticalLayout_2->addWidget(EyeRecruiter_6);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        EyeRecruiter1->setText(QString());
        EyeRecruiter_2->setText(QString());
        EyeRecruiter_3->setText(QString());
        EyeRecruiter_4->setText(QString());
        EyeRecruiter_5->setText(QString());
        EyeRecruiter_6->setText(QString());
    } // retranslateUi
